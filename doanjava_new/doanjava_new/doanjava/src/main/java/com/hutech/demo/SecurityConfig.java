    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/products/edit/**", "/products/add", "/products/delete","/categories/add","/categories/edit/**","/categories/delete","/categories","/order","/order/detail/**")
                        .hasAnyAuthority("ADMIN") // Chỉ cho phép ADMIN truy cập.
                        .requestMatchers("/orderuser")
